...
public class OVRGrabbable : MonoBehaviour
{
	...
	private AutoQUESTGenericMonitorUnity autoQuest;
	...
	virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
	{
		...
		autoQuest.LogEvent("objectGrabbed", gameObject);//, new KeyValuePair<string, string>("targetId", gameObject.name), new KeyValuePair<string, string>("targetPosition", "(" + gameObject.transform.position.x + ", " + gameObject.transform.position.y +
	...
	virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
	{
		...
		autoQuest.LogEvent("objectUngrabbed", gameObject);
	}
	...
	protected virtual void Start()
	{
		...
		autoQuest = AutoQUESTGenericMonitorUnity.getInstance();
	}
